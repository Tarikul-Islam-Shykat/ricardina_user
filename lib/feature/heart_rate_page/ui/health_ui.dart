...
import 'package:prettyrini/feature/heart_rate_page/controller/health_controller.dart';
import 'package:prettyrini/feature/heart_rate_page/model/health_card_model.dart';

class HealthCardsScreen extends StatelessWidget {
          ...
          Container(
            ...
            child: Obx(() => ListView(
              ...
              children: [
                ...
                ...HealthType.values.map((type) => Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      Colors.transparent,
                      controller.getTypeColor(card.type).withOpacity(0.1),
                      controller.getTypeColor(card.type).withOpacity(0.8),
                    ],
